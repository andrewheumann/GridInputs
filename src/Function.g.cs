...
namespace GridInputs
{
    public class Function
    {
        ...
        private IModelStore<GridInputsInputs> store;

        public async Task<GridInputsOutputs> Handler(GridInputsInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<GridInputsInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<GridInputsInputs,GridInputsOutputs>(store, GridInputs.Execute);
